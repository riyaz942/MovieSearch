      ...
      >
        <div className={styles.scrolling_container}>
          <div className={styles.content_container}>
            ...
            <div className={styles.sub_title}>{`${movieDetails.Year} | ${movieDetails.Rated} | ${movieDetails.Runtime}`}</div>
            ...
            <div className={styles.split_container}>
              ...
              <div className={styles.description}>{movieDetails.Director}</div>
            </div>
